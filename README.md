...
> 详细路线图见 `docs/roadmap-growth-engine.md` 与 `DESIGN.md`；旧的单次生成接口（`/api/v1/campaign/generate`）与下文 “Phase 1 / Phase 2” 仍保留并可用，但已被上述团队 OS 取代——阅读时请以本节为准。均 mock-first、provider 可换。当前后端 **170** 个测试 + 前端 typecheck/build/Vitest 全绿。
