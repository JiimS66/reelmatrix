...
| | |
| --- | --- |
| TestSprite account | `JiimSmith66@outlook.com` |
| Frontend project | `ReelMatrix` · id `0e9b9bee-2ca7-4553-9706-3857a3e65289` |
| Backend project | `reelmatrix-api` · id `364babc2-b2b6-43e8-a6b2-4edd5f535e07` |
| CLI version | `0.2.0` |
